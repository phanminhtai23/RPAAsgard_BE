...
export function announce(message, title) {
    console.log(
        boxen(message, {
            padding: 1,
            margin: 3,
...
export async function drawObserveOverlay(page, results) {
...
export async function simpleCache(instruction, actionToCache) {
...
export async function readCache(instruction) {
    try {
        const existingCache = await fs.readFile("cache.json", "utf-8");
 ...
 */
export async function actWithCache(page, instruction) {
